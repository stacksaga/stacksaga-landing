...
export const metadata: Metadata = {
    title: "StackSaga - The Ultimate Saga Orchestration Solution for Spring Boot",
    description: "StackSaga is the ultimate, free Saga orchestration solution for Spring Boot — covering long-running distributed transactions in microservices with built-in compensation, retry agents, and transaction tracing.",
    keywords: [
        "StackSaga",
        "stack saga",
        "saga orchestration",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "StackSaga - The Ultimate Saga Orchestration Solution for Spring Boot",
            }
        ],
        title: "StackSaga - The Ultimate Saga Orchestration Solution for Spring Boot",
        description: "StackSaga is the ultimate, free Saga orchestration solution for Spring Boot — covering long-running distributed transactions in microservices with built-in compensation, retry agents, and transaction tracing.",
