...
export const metadata: Metadata = {
    title: "StackSaga - Ultimate Solution for Saga Orchestration in Spring Boot",
    description: "StackSaga is the ultimate, free solution for Saga orchestration in Spring Boot. Manage long-running distributed transactions in microservices with built-in compensation, retry agents, and transaction tracing.",
    keywords: [
        "StackSaga",
        "stack saga",
        "saga orchestration",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "StackSaga - Ultimate Solution for Saga Orchestration in Spring Boot",
            }
        ],
        title: "StackSaga - Ultimate Solution for Saga Orchestration in Spring Boot",
        description: "StackSaga is the ultimate, free solution for Saga orchestration in Spring Boot. Manage long-running distributed transactions in microservices with built-in compensation, retry agents, and transaction tracing.",
