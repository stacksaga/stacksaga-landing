    ...
    <section className="relative pt-32 pb-20 px-4 overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl text-center">
        <div className="inline-block mb-6 px-4 py-1.5 rounded-full border border-border bg-card text-sm text-muted-foreground">
          Orchestrate microservices with confidence
        </div>

        <h1 className="text-5xl md:text-7xl font-bold mb-6 text-balance leading-tight">
          The Java Framework for <span className="text-accent">Saga Pattern</span>
        </h1>

        <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-3xl mx-auto text-pretty leading-relaxed">
          Manage long-running transactions in microservice architectures with reliability and ease. StackSaga provides
          battle-tested implementations for both synchronous and event-driven patterns.
        </p>
