        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="p-8 border-border bg-card hover:border-accent/50 transition-all">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Core implementation for orchestrating long-running transactions within request-response patterns. Perfect
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="flex items-start gap-2">
                <div className="mt-1 h-1.5 w-1.5 rounded-full bg-accent" />
                <span className="text-sm text-muted-foreground">Synchronous transaction orchestration</span>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 h-1.5 w-1.5 rounded-full bg-accent" />
          ...
          <Card className="p-8 border-border bg-card hover:border-accent/50 transition-all">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Event-driven implementation built on Apache Kafka for managing long-running transactions in distributed
